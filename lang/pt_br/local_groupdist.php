...
$string['auditallgroups'] = 'Todos os grupos desta execução';
$string['auditby'] = 'Aplicada por';
$string['auditclearfilters'] = 'Limpar filtros';
$string['auditcountergroups'] = 'Mostrando {$a->shown} de {$a->total} grupos · {$a->members} participantes';
$string['auditcountermembers'] = 'Mostrando {$a->shown} de {$a->total} participantes';
...
$string['auditnomatches'] = 'Nenhum grupo ou participante desta execução corresponde à pesquisa atual.';
...
$string['auditsearchgroup'] = 'Pesquisar grupos';
$string['auditsearchparticipant'] = 'Pesquisar participantes';
$string['auditshowmoremembers'] = 'Mostrar mais {$a}';
...
$string['groupsourcelabel'] = 'Grupo: {$a}';
...
$string['noopallplaced'] = 'Todos os participantes que correspondem aos filtros já pertencem ao grupo em que esta execução os colocaria, portanto não há nada a adicionar.';
$string['noopheading'] = 'Esta execução não adicionaria ninguém';
$string['noophintignoregrouped'] = 'O filtro "Ignorar usuários já nos grupos selecionados" está ativo, então quem já foi alocado por uma execução anterior fica de fora.';
$string['noopnocandidates'] = 'Nenhum participante do curso corresponde aos filtros exibidos acima, portanto não há ninguém para distribuir.';
$string['noopnogroups'] = 'Nenhum dos grupos selecionados existe mais — eles foram excluídos enquanto esta pré-visualização estava aberta. Volte e escolha os grupos novamente.';
$string['noopnoroom'] = 'Há participantes que correspondem aos filtros, mas nenhum grupo pode recebê-los: ou todos os grupos estão lotados, ou os únicos com vaga são grupos a que eles já pertencem. Ajuste as vagas, o overbooking ou os grupos selecionados.';
...
$string['rulegroupdestinationalso'] = '{$a} — também é destino desta distribuição';
$string['rulegroupdestinationblocked'] = '{$a} — é destino desta distribuição (indisponível)';
$string['rulegrouplabel'] = 'Grupo da regra {$a}';
$string['rulegroupsearchlabel'] = 'Busca de grupo da regra {$a}';
...
$string['rulesearchnogroups'] = 'Nenhum grupo encontrado';
...
$string['unsavedleave'] = 'As alterações em {$a} grupo(s) ainda não foram salvas. Sair desta página e descartá-las?';
$string['unsavedleavebutton'] = 'Sair e descartar';
$string['unsavedtitle'] = 'Alterações não salvas';
...
$string['warningunassigned'] = '{$a} participantes não puderam ser alocados em nenhum grupo. Verifique as vagas e o overbooking, e se eles já pertencem aos grupos selecionados.';
