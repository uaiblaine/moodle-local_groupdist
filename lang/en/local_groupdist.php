...
$string['cleanupfieldsonuninstall_desc'] = 'If enabled, uninstalling the plugin deletes the group custom fields it provisioned ("Seats", "Location") together with the values stored in them for every group. If disabled, the fields and their data are kept and can be managed under group custom fields.';
...
$string['grouplocation'] = 'Location: {$a}';
...
$string['noseatsnote'] = '{$a->noseats} of the {$a->total} selected groups have no "Seats" value — they are treated as unlimited.';
...
$string['privacy:metadata'] = 'The Group distribution plugin does not store any personal data. Distributions are recomputed from a seed, memberships live in core group tables, and the provisioned group fields describe groups, not people.';
...
$string['useseats'] = 'Respect the groups\' "Seats" field';
$string['useseats_help'] = 'Each group receives at most the number of participants declared in its "Seats" custom field (minus current members, plus overbooking). Groups without a value are treated as unlimited.';
...
$string['warningnoseats'] = '{$a} selected groups declare no "Seats" value and are treated as unlimited.';
