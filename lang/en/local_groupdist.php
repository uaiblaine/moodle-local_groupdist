...
$string['auditallgroups'] = 'All groups of this run';
$string['auditby'] = 'Applied by';
$string['auditclearfilters'] = 'Clear filters';
$string['auditcountergroups'] = 'Showing {$a->shown} of {$a->total} groups · {$a->members} participants';
$string['auditcountermembers'] = 'Showing {$a->shown} of {$a->total} participants';
...
$string['auditnomatches'] = 'No group or participant of this run matches the current search.';
...
$string['auditsearchgroup'] = 'Search groups';
$string['auditsearchparticipant'] = 'Search participants';
$string['auditshowmoremembers'] = 'Show {$a} more';
...
$string['groupsourcelabel'] = 'Group: {$a}';
...
$string['noopallplaced'] = 'Every participant who matches the filters already belongs to the group this run would have placed them in, so there is nothing to add.';
$string['noopheading'] = 'This run would not add anyone';
$string['noophintignoregrouped'] = 'The "Ignore users already in the selected groups" filter is on, so anyone a previous run already placed is left out.';
$string['noopnocandidates'] = 'No course participant matches the filters shown above, so there is nobody to distribute.';
$string['noopnogroups'] = 'None of the selected groups exist any more — they were deleted while this preview was open. Go back and choose the groups again.';
$string['noopnoroom'] = 'Participants match the filters, but no group can take them: either every group is full, or the only ones with room are groups they already belong to. Adjust the seats, the overbooking, or the selected groups.';
...
$string['rulegroupdestinationalso'] = '{$a} — also a destination of this run';
$string['rulegroupdestinationblocked'] = '{$a} — a destination of this run (unavailable)';
$string['rulegrouplabel'] = 'Rule {$a} group';
$string['rulegroupsearchlabel'] = 'Rule {$a} group search';
...
$string['rulesearchnogroups'] = 'No matching groups';
...
$string['unsavedleave'] = 'Changes to {$a} group(s) have not been saved yet. Leave this page and discard them?';
$string['unsavedleavebutton'] = 'Leave and discard';
$string['unsavedtitle'] = 'Unsaved changes';
...
$string['warningunassigned'] = '{$a} participants could not be placed in any group. Check the seats and the overbooking, and whether they already belong to the selected groups.';
